...
void drawatt() {
	textr(_all, txc, "���Ѿ��Ķ���https://github.com/Moiezen/HS_SPR_CAL/README.md�����Ҹ�HSSPRCAL.exe��ֱ�ӻ�ȡ�����°汾");
...
void st2doms(state st) {
	...
	//autoread�õ����ƿ����ʵ���Ͽ��ܳ���10
	//��UI�����Լ�֮��ļ��㲿�֣��ݽ����ǲ�����10���ƿ����
...
void touch(domain toselect) {
	...
	switch (toselect.type) {
		...
		case lk1: {
			...
			char _lk[105] = {};
			inputbox_getline(hint_s().c_str(), "��������", _lk, 100);
			domain tmp = id2dom(lkdomid);
			tmp.name = _lk;
			savedftlk(tmp.name);
			drawfixdom(tmp);
